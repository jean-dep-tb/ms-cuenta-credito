...
@RestController
public class TipoCreditoProductoControllers {

	
	@Autowired
	private TipoCreditoProductoService  tipoProductosService;
	
	@GetMapping
	public Mono<ResponseEntity<Flux<TipoCuentaCredito>>> findAll() 
	{
		return Mono.just(
				ResponseEntity
				.ok()
	...
	@GetMapping("/{id}")
	public Mono<ResponseEntity<TipoCuentaCredito>> viewId(@PathVariable String id){
	...
	@PutMapping
	public Mono<TipoCuentaCredito> updateProducto(@RequestBody TipoCuentaCredito tipoProducto)
	{
	...
	@PostMapping
	public Mono<TipoCuentaCredito> saveTipoProducto(@RequestBody TipoCuentaCredito tipoProducto)
	{
		return tipoProductosService.saveTipoProducto(tipoProducto);
	}	
